...
def extract_text_blocks(pdf_path, save_to_output=False):
    ...
    No files are saved by default - blocks are only returned in memory.
    """
    ...
    # Removed file saving functionality - blocks are only returned in memory
...
if __name__ == '__main__':
    ...
    print(f"Extraction complete. No files saved - blocks returned in memory only.") 